---
title: Laboratoriji
source: https://fri.uni-lj.si/sl/raziskave/laboratoriji
---
...
- digital logic design of fast and energy-efficient arithmetic circuits, approximate multiplier design, accelerators for machine learning algorithms,
- high performance computing, GPU processing, heterogeneous systems,
- artificial neural networks, data clustering, information-theoretic modelling and reinforcement learning,
- smart wireless sensor networks, radio-based localization and software-defined radio
...
V Laboratoriju za strojno učenje in jezikovne tehnologije (SUJT) raziskujemo področja podatkovnega rudarjenja, nevronskih mrež, umetne inteligence, analize velikih podatkovnih baz, analize podatkovnih tokov, večina raziskav pa zajema strojno učenje.
Naše delo se osredotoča na razumevanje in obdelavo jezika v različnih kontekstih, kot so zdravstvo, farmacija in digitalna humanistika. Naša raziskovalna podpodročja so modeliranje numeričnih, simbolnih, slikovnih, tekstovnih in prostorskih podatkov, medicinska diagnostika in prognostika, generiranje delno umetnih podatkov in jezikovne tehnologije.
