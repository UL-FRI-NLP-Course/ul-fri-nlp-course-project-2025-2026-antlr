---
title: Multimedija
source: https://fri.uni-lj.si/sl/studijski-program/multimedija
---
...
* Predmetnik je podrobneje predstavljen na spletni strani [**multimedija.info**](https://multimedija.info/dodiplomski-studij-predmetnik/) ter na spletni strani Fakultete za elektrotehniko UL: [**Multimedija**](https://fe.uni-lj.si/studij/dodiplomski-studij/multimedija/predmetnik/).
  + [Shema predmetnika v slovenskem jeziku](/upload/Slike/predmetniki/2026_FRI_predmetnik_1_stopnja_BUN-MM.pdf) (Scheme of the curriculum in Slovenian language)
* The curriculum in English is published on the web page **[multimedija.info](https://multimedija.info/en/undergraduate-study-subjects/)** and on the web page of the Faculty of Electrical Engineering: **[Multimedia](https://fe.uni-lj.si/en/studij/dodiplomski-studij/multimedija/predmetnik/)**.
...
* Študent univerzitetnega študijskega programa 1. stopnje Multimedija se lahko vpiše v 2. letnik, če mu do vpisnega roka od študijskih obveznosti 1. letnika manjka največ en predmet.
* Študent univerzitetnega študijskega programa 1. stopnje Multimedija se lahko vpiše v 3. letnik, če do vpisnega roka opravi vse obveznosti 1. letnika (60 ECTS) in mu od študijskih obveznosti 2. letnika manjka največ en predmet.

Skladno s Statutom Univerze v Ljubljani se študent lahko izjemoma vpiše v višji letnik, tudi če ni opravil vseh predpisanih obveznosti za napredovanje, kadar ima za to opravičene razloge, kot so npr.: materinstvo, daljša bolezen, izjemne družinske in socialne okoliščine, priznan status osebe s posebnimi potrebami, aktivno sodelovanje na vrhunskih strokovnih, kulturnih in športnih prireditvah ter aktivno sodelovanje v organih univerze. O morebitnem izjemnem vpisu na podlagi študentove vložene prošnje odloča Komisija za reševanje študentskih vlog UL FE.
...
Več preberite na uradni spletni strani študijskega programa Multimedije: [**multimedija.info**](https://multimedija.info/), ter na spletni strani Fakultete za elektrotehniko UL: [**Multimedija**](https://fe.uni-lj.si/studij/dodiplomski-studij/multimedija/).
