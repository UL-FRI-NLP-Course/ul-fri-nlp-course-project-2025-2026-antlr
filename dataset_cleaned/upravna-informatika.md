---
title: Upravna informatika
source: https://fri.uni-lj.si/sl/studijski-program/upravna-informatika
---
...
* Predmetnik je podrobneje predstavljen na spletni strani Fakultete za upravo UL: [**Upravna informatika**](https://www.fu.uni-lj.si/programi/upravna-informatika/).
  + [Shema predmetnika v slovenskem jeziku](/upload/Slike/predmetniki/2026_FRI_predmetnik_1_stopnja_BUN-UI.pdf) (Scheme of the curriculum in Slovenian language)
* The curriculum in English is published on the web page of the Faculty of Public Administration: **[Informatics in Public Administration](https://www.fu.uni-lj.si/en/programi/informatics-in-public-administration/).**
...
* Sposobnost delovanja v okviru interdisciplinarnih strokovnih skupin.
* Sposobnost vseživljenjskega učenja v družbi znanja.
* Sposobnost prevzemanja odgovornosti in etično delovanje.
* Sposobnost strokovnega sporazumevanja v maternem in vsaj enem tujem jeziku.
* Sposobnost jasne predstavitve strokovnih mnenj.
* Sposobnost komuniciranja v različnih kontekstih in oblikah.

**Predmetnospecifične kompetence, ki se pridobijo s programom:**

* Povezovanje, prenašanje in uporaba znanj z interdisciplinarnih področij.
* Razumevanje in sposobnost analitične presoje na področjih organizacije in menedžmenta.
...
* Sposobnost samostojnega opravljanja razvojnih inženirskih nalog na posameznih področjih ter samostojnega reševanja nalog.
* Temeljna usposobljenost na področjih upravnih znanosti, računalništva in informatike.
* Sposobnost definiranja, razumevanja in ustvarjalnega reševanja strokovnih izzivov in problemov na področjih informatike ter upravljanja v javnem in zasebnem sektorju.
...
V skladu z določbami meril za prehode med študijskimi programi, se na univerzitetni študijski program Upravna informatika 1. stopnja lahko vpišejo:

1. kandidati, ki prehajajo iz študijskega programa, ki ob zaključku študija zagotavlja pridobitev primerljivih kompetenc in
2. kandidati, ki prehajajo iz študijskega programa, iz katerega se lahko po kriterijih za priznavanje prizna vsaj polovica obveznosti po Evropskem prenosnem kreditnem sistemu (ECTS) iz študijskega programa, iz katerega prehajajo in se nanašajo na obvezne predmete drugega študijskega programa;

Kandidati morajo izpolnjevati pogoje za vpis v program, v katerega prehajajo. Pristojni organ za vsakega kandidata posebej določi morebitne diferencialne in druge obveznosti, ki jih mora kandidat opraviti do zaključka študija.
...
Diplomanti se lahko vključujejo v magistrske študijske programe skladno s pogoji, ki jih določa visokošolski zavod, ki razpisuje magistrske študijske programe.

Več o tem študijskem programu si lahko preberete na **[spletni strani Fakultete za upravo UL](https://www.fu.uni-lj.si/programi/upravna-informatika/)**.
