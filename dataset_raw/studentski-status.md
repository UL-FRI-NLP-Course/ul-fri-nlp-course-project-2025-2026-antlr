---
title: Študentski status
source: https://fri.uni-lj.si/sl/studentski-status
---
...
Študenti, ki nimajo pogojev za napredovanje v višji letnik ali ponavljanja letnika v naslednjem študijskem letu, lahko pavzirajo in [se prijavijo na opravljanje predmetov (prijava na laboratorijske vaje)](https://www.fri.uni-lj.si/sl/vpis).
...
**Opravljanje laboratorijskih vaj in izpitov je tekom pavziranja plačljivo skladno z [veljavnim Cenikom UL FRI.](https://www.fri.uni-lj.si/sl/pravilniki-vloge-ceniki)Plačilo laboratorijskih vaj poteka skladno [z navodili pri prijavi,](https://www.fri.uni-lj.si/sl/vpis)računi za izpite pa so izdane šele po vpisu končne ocene izpita v sistem STUDIS.**

* **NADALJEVANJE ŠTUDIJA PO PREKINITVI ZA VEČ KOT 2 LETI/ 10 LET OD POTEKA REDNEGA STATUSA ŠTUDENTA**

**Če sta minili najmanj več kot 2 leti/10 let** od poteka rednega statusa študenta, je za nadaljevanje študija najprej potrebno oddati prošnjo za nadaljevanje študija po prekinitvi preko sistema **STUDIS** (tip prošnje: Prošnja za nadaljevanje študija po prekinitvi za več kot 2 leti/ 10 let).
...
Študenti s posebnimi potrebami lahko zaprosijo za posebne olajšave pri opravljanju izpitov, odvisno od vrste in stopnje telesne okvare. Študent, ki želi pridobiti status študenta s posebnimi potrebami, mora **preko sistema STUDIS predloži prošnjo za priznanje tega statusa**, **skupaj z ustreznimi dokazili o težavah oziroma ovirah (zlasti izvidi zdravstvene oz. druge ustanove - bolnišnice, rehabilitacijski centri, svetovalni centri) o kroničnih ali dalj časa trajajočih boleznih, okvarah oziroma motnjah, primanjkljajih, odločbah o statusih invalidov, mnenjih invalidske komisije oziroma komisije za usmerjanje otrok, mladostnikov oziroma mlajših polnoletnih oseb z motnjami v telesnem in duševnem zdravju. Prošnja se lahko odda od začetka študijskega leta, od 1. 10. dalje.**

Prošnje so razrešene na sejah Komisije za študijske zadeve, predhodno ob oddaji popolne prošnje pa je študent vabljen na pogovor s koordinatorjem študentov s posebnimi potrebami.**Skladno z uveljavljeno prakso, vas obveščamo da celotni proces pridobitve statusa študenta s posebnimi potrebami lahko traja tudi več kot 60 dni.**Glede na posebne potrebe študenta komisija določi pogoje in olajšave za opravljanje izpitov in študijskih obveznosti študenta.
...
**Koordinator za študente s posebnimi potrebami je** doc. dr. Aljaž Zalar ([aljaz.zalar@fri.uni-lj.si](http://aljaz.zalar@fri.uni-lj.si)).

* [**Storitve Socialnopedagoške in psihološke svetovalnice za študente/-ke s posebnimi potrebami**](https://www.uni-lj.si/novice/2025-12-24-storitve-specialnopedagoske-in-psiholoske-svetovalnice-za-studentke-in-studente-s-posebnimi-potrebami?utm_medium=email&utm_source=newsletter_361&utm_campaign=e-univerzitetnik---januar-2026&utm_id=361)
...
Objavljeno decembra 2020 na: <https://www.uni-lj.si/studij/studenti-s-posebnim-statusom>

* **Brezplačne svetovalne ure za študente s posebnimi potrebami**

Študenti s posebnimi potrebami, ki se pri študiju srečujejo s težavami, ali pa jih morda skrbi prilagoditev študijskega procesa, iskanje in izvedba študijske prakse ali pa se sprašujejo, kako bo potekala njihova poklicna pot in kakšne so njihove možnosti na trgu dela, se lahko prijavijo na brezplačne svetovalne ure, ki jih preko Zoom-a nudijo sodelavci projekta Prehod mladih. Za prijavo na svetovanje lahko študenti pišejo preko [e-svetovalnice](https://prehodmladih.si/e-svetovalnica/)  projekta Prehod mladih in prejeli bodo povezavo na Zoom svetovanje.
...
- gradiva za zaposlene, ki so lahko v pomoč študentom in drugim, ki se znajdejo v duševni stiski. Med gradivi so vključeni priročniki, priporočila, konkretni napotki, viri pomoči in podpore, videonasveti in priporočena literatura. [Tukaj.](https://www.uni-lj.si/studij/dusevno-zdravje)

- pregled koristnih informacij, podpore in dogodkov za študente, ki se jih redno posodablja. [Tukaj.](https://kc.uni-lj.si/novice/pregled-uporabnih-informacij-za-tudente-v-asu-epidemije-.html)
...
Za pridobitev statusa študenta športnika mora študent preko sistema STUDIS oddati **prošnjo** Komisiji za študijske zadeve s priloženimi dokazili o kategorizaciji (Obvestila OKS, v katerih so objavljeni seznami kategoriziranih športnikov, ali potrdilo OKS).
